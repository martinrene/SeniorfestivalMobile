  ...
  <ion-page>
    ...
    <ion-segment-view>
      <ion-segment-content id="name">
        <ion-list lines="none" style="margin-bottom: 100px">
          <ion-item-group
...
import { IonPage, IonSegment, IonSegmentView, IonSegmentButton, IonSegmentContent, IonLabel, IonList, IonItemGroup, IonItemDivider, IonItem } from "@ionic/vue";
